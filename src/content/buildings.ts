...
const BUILDING_FUNCTION: Record<BuildingId, string> = {
  villageHall: 'Provides 500 gold income each day.', townHall: 'Raises daily city income to 1,000 gold.',
  cityHall: 'Raises daily city income to 2,000 gold.',
  ...
  walls: 'Adds wall defenses to city battles.', keep: 'Strengthens walls and adds a watchtower to city battles.',
  ...
  lychgate: 'Strengthens Unfinished city death effects.', rendery: 'Doubles Larvae produced by Render Down.',
