...
export const ARTIFACTS: Record<ArtifactId, ArtifactDefinition> = {
  ...
  standardBearersBaldric: artifact('standardBearersBaldric', "Standard-Bearer's Baldric", 'cloak', 'charm', '+3 meter/round.', ['round_meter'], { amount: 3 }),
  ...
  bannerOfTheFirstField: artifact('bannerOfTheFirstField', 'Banner of the First Field', 'cloak', 'relic', 'Meters trigger at 80.', ['meter_threshold'], { amount: 80 }),
  patchworkStandard: artifact('patchworkStandard', 'The Patchwork Standard', 'cloak', 'relic', 'No mixed-faction penalty; +5 meter per faction.', ['mixed_faction_meter'], { amount: 5 }),
  ...
  bellsClapper: artifact('bellsClapper', "The Bell's Clapper", 'weapon', 'relic', 'Once per battle set every meter to zero.', ['reset_meters']),
  ...
  drumOfTheDeepGrass: artifact('drumOfTheDeepGrass', 'Drum of the Deep Grass', 'misc', 'trinket', '+5 meter/round.', ['round_meter'], { amount: 5 }),
  ...
  bellMetalTorque: artifact('bellMetalTorque', 'Bell-Metal Torque', 'amulet', 'charm', 'Your meter drains 50% less.', ['reduced_meter_drain'], { percent: 50 }),
  ...
  longSpoon: artifact('longSpoon', 'The Long Spoon', 'weapon', 'relic', 'Once per battle, consume one counter pile and gain five meter per counter.', ['eat_counter']),
  firstDrum: artifact('firstDrum', 'The First Drum', 'misc', 'relic', 'Round-start meter gains double in rounds 1–2.', ['early_double_meter'], { amount: 1 }),
