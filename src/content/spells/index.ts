...
export const SPELLS: Record<SpellId, SpellDefinition> = Object.fromEntries([
  spell('rally', 'Rally', 'rite', 5, 'staple', 'Ally +50 morale.', 'Two allies +50.', 'strongestAlly'),
  spell('blessing', 'Blessing', 'rite', 3, 'staple', 'Next attack rolls maximum.', 'Also +10 morale.', 'strongestAlly'),
  spell('standardOfDawn', 'Standard of Dawn', 'rite', 5, 'enchantment', 'Kills grant +10 morale.', 'Immune to morale drain.', 'enchantmentSlot', 'round1'),
  spell('amplify', 'Amplify', 'rite', 4, 'twister', 'Double an active effect.', 'Also extend decay/duration.', 'counterPile', 'always', 'amplify'),
  ...
  spell('consecrate', 'Consecrate', 'rite', 3, 'staple', 'Cleanse and heal 8%.', 'Heal 15%; counters grant morale.', 'weakestAlly'),
  spell('hymnOfTheHost', 'Hymn of the Host', 'rite', 5, 'scaling', 'Allies gain 8 morale per extra action.', 'Gain ×1.5.', 'self'),
  ...
  spell('reflect', 'Reflect', 'craft', 4, 'twister', 'Copy an effect to another target.', 'Copy to two targets.', 'counterPile', 'always', 'reflect'),
  ...
  spell('unmake', 'Unmake', 'craft', 4, 'staple', 'Destroy enchantment or counters.', 'Do both.', 'counterPile', 'always', 'unmake'),
  ...
  spell('graveChill', 'Grave-Chill', 'grave', 3, 'staple', 'Chill 3.', 'Also −20 morale.'),
  ...
  spell('lastCandle', 'Last Candle', 'grave', 5, 'enchantment', 'Allied death: enemies Hex 2, allies +20 morale.', 'Also refund 2 mana.', 'enchantmentSlot', 'round1'),
  spell('sour', 'Sour', 'grave', 4, 'twister', 'Invert a beneficial effect.', 'Destroyed enchantment Hexes enemies.', 'counterPile', 'always', 'sour'),
