...
export const EXPANSION_UNITS = {
  oriflammeWyvern: {
    ...
    cost: { gold: 3200, iron: 3, essence: 1 }, abilities: ['flying', 'rampant'],
  },
  reliquaryArk: {
  ...
  dragonflyCavalry: {
    ...
    cost: { gold: 1350, essence: 1 }, abilities: ['flying', 'skim'],
  },
  halfWokenQueen: {
  ...
  fencePostFamiliars: {
    ...
    cost: { gold: 170 }, abilities: ['boundary'],
  },
  besomRiders: {
  ...
  rusalka: {
    ...
    cost: { gold: 700, essence: 1 }, abilities: ['spirit', 'beckoning_song', 'aquatic'],
  },
  leshy: {
    ...
    abilities: ['beast', 'home_ground', 'thicket_walk'],
  },
  walkingHut: {
    ...
    abilities: ['fowl_legs', 'crone_favor'],
  },
  ...
  drumCallers: {
    ...
    cost: { gold: 190 }, abilities: ['war_drums'],
  },
  ashmaneWolves: {
  ...
  thunderbird: {
    ...
    abilities: ['flying', 'beast', 'storm_wake'],
  },
