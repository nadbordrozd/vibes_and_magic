...
export const NON_ADVENTURE_SURFACES = [
  ...
  { id: 'combat-spellbook', component: 'SpellbookPanel', primaryJob: 'Choose one legal combat spell.', primaryState: 'Mana, active version, cost, and availability.', primaryAction: 'Select, then cast or close.', referenceRoute: 'inspection', representative: 'spellbook' },
  { id: 'adventure-spellbook', component: 'AdventureSpellbook', primaryJob: 'Choose one legal map spell.', primaryState: 'Mana, movement, active version, and availability.', primaryAction: 'Select, then cast or close.', referenceRoute: 'inspection' },
