...
const FRIENDLY_REASONS: Record<string, string> = {
  ...
  'The Writ cannot be paid': 'That city has no tier-one stock or its doubled cost cannot be paid.',
  'No army slot for the militia': 'That city garrison has no matching or empty company slot.',
