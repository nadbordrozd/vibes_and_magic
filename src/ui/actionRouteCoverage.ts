...
export const HUMAN_ACTION_ROUTES = {
  ...
  ARTIFACT_CROSS_TERRAIN: { surface: 'AdventureHeroDetails artifact actions', handling: 'visible-target-mode' },
  ARTIFACT_RETURN_TO_START: { surface: 'AdventureHeroDetails artifact actions', handling: 'visible-control' },
  ARTIFACT_MARKER: { surface: 'AdventureHeroDetails artifact actions', handling: 'visible-control' },
  ARTIFACT_SKIP_GUARD: { surface: 'AdventureMap guarded reward', handling: 'visible-target-mode' },
  ARTIFACT_REMOTE_TRANSFER: { surface: 'AdventureHeroDetails artifact courier', handling: 'visible-control' },
  ARTIFACT_MOVE_STAT: { surface: 'AdventureHeroDetails artifact actions', handling: 'visible-control' },
  ARTIFACT_PAY_REMOVAL: { surface: 'CastleScreen Marketplace artifact payment', handling: 'visible-control' },
  ...
  CHOOSE_ADEPT_SPELL: { surface: 'ChoiceDialog', handling: 'pending-choice' },
  CHOOSE_DUELIST_ARTIFACT: { surface: 'ChoiceDialog', handling: 'pending-choice' },
  ...
  DISMISS_GUILD_REVEAL: { surface: 'CastleScreen Mage Guild reveal', handling: 'visible-control' },
  ...
  MARKET_DIRECT_EXCHANGE: { surface: 'CastleScreen Marketplace', handling: 'visible-control' },
  BUY_MARKET_SCROLL: { surface: 'CastleScreen Marketplace', handling: 'visible-control' },
  REFRESH_LOGISTICS: { surface: 'AdventureHeroDetails', handling: 'visible-control' },
  DESIGNATE_TACTICIAN: { surface: 'AdventureHeroDetails', handling: 'visible-control' },
  REMOTE_RECRUIT: { surface: 'CastleScreen recruitment', handling: 'visible-control' },
  ...
  USE_ACQUISITION_SITE: { surface: 'AdventureStructureDialog', handling: 'visible-control' },
  CHOOSE_ACQUISITION_SPELL: { surface: 'ChoiceDialog', handling: 'pending-choice' },
  ...
  BATTLE_USE_SKILL: { surface: 'CombatScreen skill targeting', handling: 'visible-target-mode' },
  BATTLE_USE_KNACK: { surface: 'CombatScreen permanent Knack control', handling: 'visible-target-mode' },
  BATTLE_CHOOSE_COUNTER_REDIRECT: { surface: 'CombatScreen opening choice', handling: 'visible-target-mode' },
  BATTLE_CHOOSE_SPELL_DEFLECT: { surface: 'CombatScreen defender spell choice', handling: 'visible-target-mode' },
  BATTLE_CHOOSE_MIRROR_COPY: { surface: 'CombatScreen mirror copy choice', handling: 'visible-target-mode' },
  BATTLE_DEPLOY_AMBUSH: { surface: 'CombatScreen deployment choice', handling: 'visible-target-mode' },
