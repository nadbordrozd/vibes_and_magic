...
export const HUMAN_ACTION_ROUTES = {
  ...
  BUY_MERCENARY: { surface: 'Adventure service card', handling: 'visible-control' },
  BUY_WAGON_ITEM: { surface: 'Adventure service card', handling: 'visible-control' },
  PAY_TITHE: { surface: 'Adventure service card', handling: 'visible-control' },
  ...
  RECRUIT_DWELLING: { surface: 'Adventure service card', handling: 'visible-control' },
  BUY_TINKER_ITEM: { surface: 'Adventure service card', handling: 'visible-control' },
  BUY_TIMING_BLESSING: { surface: 'Adventure service card', handling: 'visible-control' },
  DEPOSIT_GLOAMING_ITEM: { surface: 'Adventure service card', handling: 'visible-control' },
  DEPOSIT_GLOAMING_ARTIFACT: { surface: 'Adventure service card', handling: 'visible-control' },
  USE_CHRYSALIS: { surface: 'Adventure service card', handling: 'visible-control' },
  COMPLETE_BRIDGE: { surface: 'Adventure service card', handling: 'visible-control' },
  ATTEND_HEDGE_SCHOOL: { surface: 'Adventure service card', handling: 'visible-control' },
  USE_RELIQUARY_CAIRN: { surface: 'Adventure service card', handling: 'visible-control' },
