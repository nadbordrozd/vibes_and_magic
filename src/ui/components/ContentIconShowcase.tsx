...
export function ContentIconShowcase() {
  return <main className="content-icon-showcase">
    <header>
      <span className="kicker">Work order 46 · native PixelLab output</span>
      <h1>Spell &amp; secondary-skill icon sheet</h1>
      <p>Every bitmap is generated and shipped at 32×32. The 64px review presentation is an exact
