...
| 60 | MAGIC_OVERHAUL | Five spell tiers, Mage Guild 1–5 with tier-gated deals, Spell-Power-scaled impact damage, mass targeting, casting-economy breakers, new effect primitives, counter payoffs, and widened spell acquisition | design work order; amends S01/S04/S05/S06/S07/S09; supersedes the three-level guild, the flat mana curve, and the pinned 68-spell/21-skill counts |
| 61 | SPELL_CATALOG_V2 | 124 spells at 31 per school across five tiers with declared scaling shapes: 56 new entries including four cantrips, 14 retunes, and the repair of all five identical Standard/Upgraded pairs | catalog companion to 60; supersedes the doc 58 equality set and the 68-spell catalog in 15/55/56 |
| 62 | COMBO_DESIGN | Twenty intended combos as acceptance cases, twelve build archetypes, AI limitations, and the hard loop bounds that separate finite blowouts from bugs | design/acceptance companion to 60–61 and 63; amends the S01 balance posture with an explicit variance stance |
| 63 | CONTENT_SUPPORT_V2 | Twenty new creature abilities, sixteen unit retunes, eight neutral combo creatures, twenty artifacts, twelve consumables, Spell Tomes, three new skills, six skill reworks, and three acquisition sites | content companion to 60–62; amends S06/S09 counts, doc 39 strength adjustments, and closes RB-001/002/003 |
| 64 | CREATURE_TRAITS_V2 | Deterministic per-creature resistance vocabulary, creature spell repertoires, six multi-hex attack patterns, aura/threshold/positional/adventure/drawback trait families, and five showcase creatures | content companion to 60–63; amends doc 62 §4's no-resistance bullet, S04/S05/S09, and doc 39 strength adjustments |
| 65 | ARTIFACTS_V2 | Thirty-seven rule-warping artifacts across adventure, economy, magic, combat, conditional, and burden axes, three small sets, and a split development/release sprite gate | content companion to 63 §2; amends S06/S09; proposes per-hero army slots and a DECISIONS entry for the sprite gate |
| 66 | SKILLS_V2 | Thirty-skill roster with six new verb skills, a rank-3 verb audit of four numeric skills, level-5 gating, and class weights | supersedes doc 63 §4; amends S06/S09 |
| 67 | FACTION_KNACKS | A free at-will hero act per faction, three level-gated ranks, AI fallback heuristics, and deferred adventure variants | new system; amends S04/S05/S06/S08/S09; gives every hero a legal action at zero mana |
