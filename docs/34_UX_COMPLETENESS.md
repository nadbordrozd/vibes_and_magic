...
| City | Ownership/visiting context, building state and prerequisites, daily build limit, recruitment availability/cost/capacity, garrison transfer, guild, tavern, market and faction services |
...
| Spellbooks | Cast timing, mana/movement cost, standard and upgraded effects, currently active version and reason, valid targets, why a spell is unavailable, Debts and triggers |
